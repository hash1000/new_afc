...
const CHECKLIST = ["Confidential Inquiry", "No Obligation", "Fast Response"];
    ...
    <section id="inquiry" className="bg-gray-50 py-20">
      <div className="container-page mx-auto grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
        <div>
          ...
          >
            <span className="text-brand-navy block">Ready to Build</span>
            <span className="text-brand-red block">Your Future?</span>
          </motion.h2>
          ...
          >
            Fill out the form and our franchise development team will be in
            touch to discuss this exciting opportunity.
          </motion.p>
